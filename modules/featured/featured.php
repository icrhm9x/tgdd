    ...
    <div class="Product">
        <div class="Product-head">
            ...
            <div class="Product-head-tag">
                <?php
                $query_prd = mysqli_query($connect, "SELECT * FROM product WHERE cat_id = {$data_cat['cat_id']} ORDER BY prd_id DESC LIMIT 4");
                ...
                <?php } ?>
                <a href="index.php?page_layout=category&cat_id=<?php echo $data_cat['cat_id'] ?>">Xem tất cả 
                <?php
                ...
                <div class="Product-content-item">
                    ...
                    <div class="Product-content-item-detail">
                        ...
                        <p class="Product-content-item-detail__price">
                            ...
                            <span><?php if($data_prd['prd_sale'] > 0){echo number_format($data_prd['prd_price'],0,'','.').'₫';} ?></span></p>
