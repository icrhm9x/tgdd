        ...
        <div class="Promotion-content">
            <div class="js-promoList Promotion-content-list">
                ...
                while ($data_prd = mysqli_fetch_assoc($query_prd)) {
                    ?>
                    <a class="Promotion-content-item" id="promo<?php echo $n ?>"
                       href="product.php?prd_id=<?php echo $data_prd['prd_id'] ?>">
                        ...
                        <div class="Promotion-content-item-detail">
                            ...
                            <p class="Promotion-content-item-detail__price">
                                <?php echo number_format($data_prd['prd_price'] - $data_prd['prd_sale'], 0, '', '.') ?>₫
                                <span><?php echo number_format($data_prd['prd_price'], 0, '', '.') ?>₫</span></p>
                            <p class="Promotion-content-item-detail__txt">Phiếu mua hàng trị giá 1,2 triệu (được quy đổi
                                thành tiền mặt)</p>
                        </div>
                    </a>
                    <?php $n++;
